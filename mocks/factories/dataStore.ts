...
// 共用常數
// ============================================================
export const DOMAINS = ['mysite.com', 'competitor-a.com', 'competitor-b.com', 'competitor-c.com'] as const;
  ...
  if (!_trackedKeywords) {
    ...
    _trackedKeywords = Array.from({ length: 248 }, (_, i) => {
      ...
      return {
        ...
        sparkline: Array.from({ length: 7 }, () => cur + faker.number.int({ min: -10, max: 10 })),
